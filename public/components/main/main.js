...
export class Main extends React.Component {
  ...
  componentDidMount() {
    ...
    */
    ...
    httpClient.get('../api/myphotos/example').then((resp) => {
          ...
          <EuiPageContent>
            <EuiPageContentHeader>
              <EuiTitle>
                <h2>
                  <FormattedMessage
                    id="myphotos.congratulationsTitle"
